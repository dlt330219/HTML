...
$(function(){
	...
	var isFieldsFold = false, isCompFold = false, isDirectionFold = false, isInterfaceFold = false, isGridsFold = false,isCompSetsFold = false, isCompSetFold = false;
	function fold(node){
	...
	function foldGrids(nextNode){
		while($.trim(nextNode.children('span').text()) != 'component_full_names_sets'){
	...
	function foldCompSets(nextNode){
		while($.trim(nextNode.children('span').text()) == 'component_full_names_set' || $.trim(nextNode.children('span').text()) == 'entry'){			
			if(!isCompSetsFold){
